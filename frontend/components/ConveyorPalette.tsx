...
const ConveyorPalette = ({ onSelectPart, containerWidth, containerHeight, canvasRect, onScoreChange, onGameEnd }: ConveyorPaletteProps) => {
  ...
  const handleKeyPress = useCallback((pressedKey: string) => {
    ...
    const partMap: Record<string, string> = {
      '一': 'ichi', '二': 'ni', '三': 'san', '四': 'shi', '五': 'go', '十': 'juu', '百': 'hyaku', '千': 'sen', '万': 'man',
      '人': 'jin', '者': 'mono', '男': 'otoko', '女': 'onna', '子': 'ko', '友': 'tomo', '親': 'oya', '家': 'ie', '民': 'tami',
      '日': 'hi', '月': 'tsuki', '年': 'toshi', '時': 'toki', '分': 'fun', '今': 'ima', '先': 'saki', '後': 'ato', '前': 'mae',
      '上': 'ue', '下': 'shita', '中': 'naka', '外': 'soto', '内': 'uchi', '左': 'hidari', '右': 'migi', '大': 'dai', '小': 'shou',
      '新': 'shin', '古': 'furu', '高': 'taka', '低': 'hiku', '長': 'naga', '短': 'tan', '多': 'oo', '少': 'suku',
      '生': 'sei', '死': 'shi2', '学': 'gaku', '校': 'kou', '教': 'kyou', '育': 'iku', '会': 'kai', '社': 'sha',
      '員': 'in', '仕': 'tsuka', '事': 'koto', '業': 'gyou', '力': 'chikara', '心': 'kokoro', '体': 'karada', '気': 'ki', '思': 'omo',
      '考': 'kanga', '知': 'shi3', '意': 'i', '味': 'aji', '理': 'ri', '由': 'yoshi', '感': 'kan', '情': 'jou', '念': 'nen',
      '見': 'mi', '聞': 'ki2', '言': 'i2', '話': 'hana', '書': 'ka', '読': 'yo', '語': 'go', '文': 'bun',
      '行': 'i3', '来': 'ki3', '出': 'de', '入': 'hai', '動': 'ugo', '止': 'to', '立': 'ta', '休': 'yasu', '働': 'hatara',
      '作': 'tsuku', '使': 'tsuka2', '用': 'mochi', '取': 'to2', '持': 'mo', '変': 'ka2', '化': 'ka3', '進': 'susu', '退': 'shirizo',
      '電': 'den', '車': 'kuruma', '駅': 'eki', '道': 'michi', '空': 'sora', '海': 'umi', '山': 'yama', '川': 'kawa', '天': 'ten',
      '水': 'mizu', '火': 'hi2', '木': 'ki4', '金': 'kin', '土': 'tsuchi', '風': 'kaze', '雨': 'ame', '雪': 'yuki',
      '食': 'ta2', '飲': 'no', '料': 'ryou', '物': 'mono2', '品': 'shina', '買': 'ka4', '売': 'u', '店': 'mise', '場': 'ba',
      '国': 'kuni', '地': 'chi', '方': 'kata', '世': 'yo2', '界': 'kai2', '全': 'zen', '部': 'bu', '別': 'betsu', '同': 'dou',
      '正': 'tada', '悪': 'waru', '良': 'yo3', '美': 'utsuku', '安': 'yasu2', '危': 'abu', '強': 'tsuyo', '弱': 'yowa', '難': 'muzuka',
      '勝': 'ka5', '負': 'ma', '戦': 'ikusa', '和': 'nago', '平': 'tai', '争': 'araso', '協': 'kyou', '調': 'totono',
      '自': 'mizuka', '他': 'ta2', '主': 'nushi', '客': 'kyaku', '公': 'ooyake', '私': 'watakushi', '直': 'nao', '接': 'tsu', '反': 'han',
    };
